...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CpmPedido.Domain.CategoriaProduto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("CpmPedido.Domain.Cidade", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("CpmPedido.Domain.Cliente", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("CpmPedido.Domain.Combo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("CpmPedido.Domain.Endereco", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("CpmPedido.Domain.ProdutoCombo", b =>
                {
                    b.Property<int>("IdProduto")
                        .HasColumnType("integer")
                        .HasColumnName("id_produto");
            ...
            modelBuilder.Entity("CpmPedido.Domain.ProdutoPedido", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("CpmPedido.Domain.PromocaoProduto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("CpmPedido.Domain.Cliente", b =>
                {
                    b.HasOne("CpmPedido.Domain.Endereco", "Endereco")
                        .WithOne("Cliente")
                        .HasForeignKey("CpmPedido.Domain.Cliente", "IdEndereco")
            ...
            modelBuilder.Entity("CpmPedido.Domain.Endereco", b =>
                {
                    b.HasOne("CpmPedido.Domain.Cidade", "Cidade")
                        .WithMany()
            ...
            modelBuilder.Entity("CpmPedido.Domain.Pedido", b =>
                {
                    b.HasOne("CpmPedido.Domain.Cliente", "Cliente")
                        .WithMany("Pedidos")
            ...
            modelBuilder.Entity("CpmPedido.Domain.Produto", b =>
                {
                    b.HasOne("CpmPedido.Domain.CategoriaProduto", "Categoria")
                        .WithMany("Produtos")
            ...
            modelBuilder.Entity("CpmPedido.Domain.ProdutoCombo", b =>
                {
                    b.HasOne("CpmPedido.Domain.Combo", "Combo")
                        .WithMany()
            ...
            modelBuilder.Entity("CpmPedido.Domain.ProdutoPedido", b =>
                {
                    b.HasOne("CpmPedido.Domain.Pedido", "Pedido")
                        .WithMany("Produtos")
